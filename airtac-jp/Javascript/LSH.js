...
if(IsOKrun)
{
	...
	case 1:
		...
		case 1:
			...
			strISOK="下記数値は、“0”又は“空白”の選択はできません："+"\n"+"1、速度V"+"\n"+"2、负荷系数fw"+"\n"+"3、行程Ls"+"\n"+"4、每分钟的往复次数n"+"\n"+"5、质量m1";
			break;
		case 2:
...
{
	window.alert("バージョンが期限切れになっているので、AIRTACに連絡して新版を入手してください。");
}
}
...
function SetJGTable(fs,L,Lh)
{
	...
	if (fs<1)
	{mytd.innerHTML = "　fs<1，使用不可, 再計算してください";}
	else 
...
function ISOK_Bs2() 
{
	...
	else
	{
		...
		if (this_BS<min_BS)
		{
			window.alert("スライダの長さより小さくすることはできません"+String(min_BS));
			document.getElementById("ID_text_Bs2").value="";
		}
	}
}
